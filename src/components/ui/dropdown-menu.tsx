...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default items-center gap-2 rounded-md px-2 py-1.5 text-sm focus:bg-accent",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    checked={checked}
    className={cn(
      "relative flex items-center rounded-md px-2 py-1.5 text-sm focus:bg-accent",
      className
    )}
    {...props}
  >
